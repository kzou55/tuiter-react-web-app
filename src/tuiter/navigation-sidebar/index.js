    ...
    return (
        <div>
            <div className="list-group">
                ...
                <a href="/tuiter" className={`list-group-item ${active === 'home'?'active':''}`}>
                    <div className="row">
            ...
            <div className="d-grid mt-2">
                <a href="/tuiter" className="btn btn-primary btn-block rounded-pill">
                    Tuit
                </a>
            </div>
        </div>
